...
- Before running any test that touches hardware/kernel modules, write your
  plan and current state to RESUME_NOTES.md, commit, and push — assume the
  machine may crash
- You have sudo permissions; run tests yourself
