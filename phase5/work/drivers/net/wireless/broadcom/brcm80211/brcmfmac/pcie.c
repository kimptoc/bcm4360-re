...
{
	pr_emerg("BCM4360 test.151: module_init entry (no BAR0 MMIO)\n");
}
...
int brcmf_pcie_register(void)
{
	...
	pr_emerg("BCM4360 test.151: brcmf_pcie_register() entry\n");
	pr_emerg("BCM4360 test.151: skipping brcmf_dbg in brcmf_pcie_register\n");
	pr_emerg("BCM4360 test.151: after skipped brcmf_dbg, before pci_register_driver\n");
	ret = pci_register_driver(&brcmf_pciedrvr);
	pr_emerg("BCM4360 test.151: pci_register_driver returned ret=%d\n", ret);
	return ret;
}
